	...
	application: {
		...
		product_not_found: {
			...
			labels: [
				...
				"Товар не найден по id!",
				"Bunaqa id li maxsulot topilmadi!",
			],
		},
		order_not_found: {
			id: 10003,
			...
			labels: [
				...
				"Заказ по идентификатору не найден!",
				"Buyurtma ID bo'yicha topilmadi!",
			],
		},
		error_create_file: {
			id: 10004,
		...
		already_send_code: {
			...
			code: "APP",
			labels: [
				"This phone number already send code!",
				"На этот номер телефона уже отправлен код!",
				"Bu telefon raqamiga kod allaqachon yuborilgan!",
			],
		},
		invalid_send_code: {
			id: 10008,
			status: "BADREQUEST",
			code: "USER",
			labels: ["Invalid code sent!", "Отправлен неверный код!", "Noto'g'ri kod yuborildi!"],
		},
		code_already_used: {
			id: 10009,
			status: "BADREQUEST",
			code: "USER",
			labels: ["Code already used!", "Код уже использован!", "Kod allaqachon foydalanilgan!"],
		},
		otp_expired: {
			id: 10010,
			status: "BADREQUEST",
			...
			labels: [
				"OTP code expired!",
				"Срок действия кода OTP истек!",
				"OTP kod muddati tugagan!",
			],
		},
		invalid_token: {
			id: 10011,
		...
		not_enough_product: {
			...
			status: "BADREQUEST",
			code: "USER",
			labels: ["Not anough product!", "Недостаточно товара!", "Mahsulot yetarli emas!"],
		},
		not_verified_user: {
			id: 10013,
			status: "BADREQUEST",
		...
		basket_not_found: {
			...
			status: "NOT FOUND",
			code: "USER",
			labels: ["Basket not found!", "Корзина не найдена!", "Karzinka topilmadi!"],
		},
		basket_already_exists: {
			id: 10015,
			status: "BADREQUEST",
			code: "USER",
			labels: [
		...
		sent_incorrect_amount: {
			...
			labels: [
				...
				"Отправлено неверное количество!",
				"Noto'g'ri Miqdor yuborilgan!",
			],
		},
		...
		image_name_not_found: {
			id: 10020,
			status: "BADREQUEST",
			code: "PRODUCT",
			labels: ["image_name not found!", "image_name не найден!", "image_name topilmadi!"],
		},
		user_already_exists: {
			id: 10021,
			status: "BADREQUEST",
		...
		password_not_match: {
			...
			status: "BADREQUEST",
			code: "USER",
			labels: ["Passwords not match!", "Пароли не совпадают!", "Parollar mos kelmaydi!"],
		},
		not_sent_message: {
			id: 10023,
			status: "BADREQUEST",
			code: "USER",
			labels: ["Message not sent!", "Сообщение не отправлено!", "Xabar yuborilmadi!"],
		},
		feedback_not_found: {
			id: 10024,
			status: "NOT FOUND",
			code: "USER",
			labels: ["Feedback not found!", "Обратная связь не найдена!", "Feedback topilmadi!"],
		},

		discount_price_not_found: {
			id: 10025,
			status: "NOT FOUND",
			code: "USER",
			labels: [
				"discount_price should not be empty!",
				"discount_price не должно быть пустым!",
				"discount_price bo'sh bo'lmasligi kerak!",
			],
		},
		discount_percent_not_found: {
			id: 10026,
			status: "NOT FOUND",
			code: "USER",
			labels: [
				"discount_percent should not be empty!",
				"discount_percent не должно быть пустым!",
				"discount_percent bo'sh bo'lmasligi kerak!",
			],
		},
		user_credit_card_not_found: {
			...
			code: "USER",
			labels: [
				"User credit card not found!",
				"Кредитная карта пользователя не найдена!",
				"Foydalanuvchi kredit kartasi topilmadi!",
			],
		},

		user_credit_card_already_exists: {
			id: 10028,
			status: "BADREQUEST",
			code: "USER",
			labels: [
				"User credit card already exists!",
				"Кредитная карта пользователя уже существует!",
				"Foydalanuvchi kredit kartasi allaqachon mavjud!",
			],
		},
		user_location_not_found: {
			...
			labels: [
				...
				"Foydalanuvchi manzil topilmadi!",
			],
		},

		product_amount_not_enough: {
			id: 10030,
			status: "NOT FOUND",
			code: "USER",
			labels: [
				"Product amount not enough!",
				"Количество продукта недостаточно!",
				"Mahsulot miqdori yetarli emas!",
			],
		},

		maximum_file_exception: {
			id: 10031,
			status: "NOT FOUND",
			code: "USER",
			labels: [
				"The product has reached the maximum number of files!",
				"Продукт достиг максимального количества файлов!",
				"Mahsulot maksimal fayllar soniga yetdi!",
			],
		},
		incorrect_otp: {
			id: 10032,
			status: "BADREQUEST",
			code: "USER",
			labels: ["Incorrect OTP!", "Неверный код OTP!", "Noto'g'ri OTP!"],
		},
		too_many_otp_attempts: {
			...
			labels: [
				...
				"Слишком много попыток OTP. Повторите попытку позже!",
				"Juda ko'p OTP urinishlar,iltimos keyinroq qayta urinib ko'ring!",
			],
		},
		invalid_status_transition:{
            ...
            status: "BADREQUEST",
            code: "USER",
            labels: ["Invalid status transition!", "Неверное перехода статуса!", "Noto'g'ri holatga o'tish!"],
		},
	},
};
